...
| Pattern                    | Description                                                                                                                                                                                                    |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Column header**          | Clickable/keyboard-navigable header cell. Click selects the column and shows the column toolbar. Shift+click extends range selection. Displays column name + type badge                                        |
...
| **Column toolbar**         | Floating `role="toolbar"` with context-sensitive actions (Sort, Filter, Rename, Split, etc.). Appears below the selected column header. Type-conditional buttons (e.g., Date Operations only for date columns) |
| **Multi-column toolbar**   | Variant of column toolbar shown when multiple columns are selected. Shows count and bulk actions (Remove)                                                                                                      |
