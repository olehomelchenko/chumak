...
| Pattern                    | Description                                                                                                                                                                                                                                                                          |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Column header**          | Clickable/keyboard-navigable header cell. Contains type badge (left), column name (center), chevron dropdown trigger (right). Click selects the column for EDA. Shift+click extends range selection                                                                                  |
...
| **Column menu**            | Dropdown `role="menu"` triggered by the chevron on a column header. Contains all column actions (Sort, Filter, Rename, Split, Duplicate, Date Ops, Dedupe, Impute, Remove) with icon+label items grouped by dividers. Replaces the former floating toolbar for single-column actions |
