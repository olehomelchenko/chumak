# KSE Visual Identity Guidelines — Web Development Summary
...
- Only 5 brand colors should be used — adding other colors ruins the rigorous brand image
...
**Step 1:** Divide medium height by 2

**Step 2 (if needed):** Divide the remaining half by 3

- **Smaller media** (e.g., social posts): Use 2 blocks only
- **Larger media** (e.g., posters, dashboards): Use 3 blocks

### Block Designation Methods

1. **Color Designation** — different brand colors for each block
2. **Line Designation** — 0.75 pt lines separating blocks
   - Dark blue lines on secondary color backgrounds (or vice versa)
...
- Natural colors
- Not too abstract or harshly realistic
- Source: EyeEm.com
...
## 8. Data Visualization (from examples)
...
- **Scatter/bubble charts:** Green dots/circles
...
## 10. Key Takeaways for Web Development

1. **Consistency:** Always include Dark Midnight Blue in every color combination
2. **Simplicity:** The brand is rigorous — avoid decorative elements, shadows, gradients
3. **Proportions:** Use the x, x×2, x×3 block system for layouts
4. **Typography:** Graphik Medium for headings (1.15 line-height), Graphik Regular for body (1.3 line-height)
5. **External vs Internal:** Public-facing products require full logotype with descriptor
6. **Avoid tautology:** Don't use "KSE" in text when logo is visible
7. **Charts:** Stick to brand colors; prefer dark blue backgrounds with cyan/green/yellow data elements
8. **Icons:** Outline style only, brand colors only, simple and clear
